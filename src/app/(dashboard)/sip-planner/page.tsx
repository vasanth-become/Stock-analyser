...
export default function SipPlannerPage() {
  ...
  // Load profile to pre-fill calculator
  useEffect(() => {
    fetch('/api/profile')
    ...
    <div className="space-y-8 max-w-6xl">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1 text-sm">
          Calculate SIP returns and get AI-curated mutual fund picks for your goals
        </p>
      </div>
      ...
      <section className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900">AI Fund Recommendations</h2>
              <p className="text-xs text-gray-500 mt-0.5">
                Personalised mutual fund picks based on your investor profile
              </p>
            </div>
          </div>
          <Button
          ...
          <Card>
            <CardContent className="py-12 flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                <p className="font-semibold text-gray-800">Finding the best funds for you…</p>
                <p className="text-sm text-gray-500 mt-1">Claude is matching your profile to mutual fund data</p>
              </div>
            </CardContent>
          </Card>
        )}
              ...
              {showStrategy && (
                <CardContent className="pt-0 pb-3">
                  ...
                  <div className="mt-3 flex items-center justify-between text-xs text-blue-700">
                    ...
                    <span>{recos.recommendations.length} funds selected</span>
                  </div>
                </CardContent>
              )}
            </Card>
            ...
            <Card className="border-amber-100 bg-amber-50">
              <CardContent className="py-3 px-4">
                <p className="text-xs text-amber-800 flex items-start gap-2">
                  ...
                  {recos.disclaimer} Mutual fund investments are subject to market risks. Read all scheme
                  related documents carefully before investing. Past performance is not indicative of future results.
                </p>
              </CardContent>
            </Card>
          </>
        ...
        {!recoLoading && !recos && !recoError && (
          <Card className="border-dashed">
            <CardHeader>
              <CardTitle className="text-base text-gray-700">Get Personalised Fund Picks</CardTitle>
              <CardDescription>
                Click &quot;Get Recommendations&quot; to let Claude analyse your investor profile and
                suggest the best mutual funds for your goals and risk tolerance.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid sm:grid-cols-3 gap-3 text-sm text-gray-600">
                {[
                  { icon: '🎯', label: 'Goal-aligned', desc: 'Matched to your wealth/tax/income goals' },
